...
PERSON_TIME_COLUMN_TEMPLATE = 'person_time_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_{EXPOSURE_GROUP}_treatment_group_{TREATMENT_GROUP}'
YLDS_COLUMN_TEMPLATE = 'ylds_due_to_{CAUSE_OF_DISABILITY_STATE}_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_{EXPOSURE_GROUP}_treatment_group_{TREATMENT_GROUP}'
DEATH_COLUMN_TEMPLATE = 'death_due_to_{CAUSE_OF_DEATH_STATE}_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_{EXPOSURE_GROUP}_treatment_group_{TREATMENT_GROUP}'
YLLS_COLUMN_TEMPLATE = 'ylls_due_to_{CAUSE_OF_DEATH_STATE}_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_{EXPOSURE_GROUP}_treatment_group_{TREATMENT_GROUP}'
TRANSITION_EVENT_COLUMN_TEMPLATE = '{TRANSITION}_event_count_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_{EXPOSURE_GROUP}_treatment_group_{TREATMENT_GROUP}'
...
STATE_PERSON_TIME_COLUMN_TEMPLATE = '{DISEASE_STATE}_person_time_in_{YEAR}_among_{SEX}_in_age_group_{AGE_GROUP}_{EXPOSURE_GROUP}_treatment_group_{TREATMENT_GROUP}'
